...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <!---criar pagina com tabelas de produtos adquirido com butão de cadastro do produtos-->
                        <a class="collapse-item" href="buttons.html">Entrada</a>
                        <!---criar pagina com tabelas de produtos vendidos-->
            ...
            <!-- Sidebar Message  contra de template PRO    -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!--Sessão de pesquisa de componentes-->
                    <!-- Topbar Search -->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!--Informações do usuario dos sistema-->
